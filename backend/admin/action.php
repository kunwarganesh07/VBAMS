...
$query_user = "SELECT * FROM tbldriver";
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                ...
                                if (isset($_POST["submit"])) {
                                    ...
                                    $accepted_by = $conn->real_escape_string($_POST['accepted_by']);


                                    // Prepare SQL query with conditional accepted_by update
                                    if ($accepted_by !== null) {
                                        $getuser = "UPDATE tblbook SET remark='$remark', Status='$status', accepted_by='$accepted_by' WHERE id=$id";
                                    }
                                    if ($accepted_by == null) {
                                        $getuser = "UPDATE tblbook SET remark='$remark', Status='$status' WHERE id=$id";
                                    }
                                    $result_update = $conn->query($getuser);


                                    $driverid = $accepted_by;
                                    $query_driver = "SELECT * FROM tbldriver WHERE driverid='$driverid'";
                                    ...
                                    $check = mail(
                                        ...
                                        "Driver Name: " . $data_driver['name'] . "\n" .
                                        "Driver Contact: " . $data_driver['phone'] . "\n\n" .
                                            ...
                                            <div class='modal-content'>
                                                ...
                                                <div class='modal-body'>
                                                        <div class='row'>
                                                            ...
                                                            <div class='col-md-12'>
                                                                <div class='form-group'>
                                                                    <label for='accepted_by'><b>Assign to:</b></label>
                                                                    <select name='accepted_by' class='form-control' required>
                                                                        <option value=''>-- Select Driver --</option>";
                                    while ($data_user = $result_user->fetch_assoc()) {
                                        echo "<option value='{$data_user['driverid']}'>{$data_user['name']}</option>";
                                    }
                                    echo "       
                                                                    </select>
                                                                </div>
                                    ...
                                    echo "       
                                                            ...
                                                            <div class='col-md-12'>
                                                                <div class='form-group'>
                                                                    <label for=''><b>Status:</b></label>
                                                                    <select name='Status' class='form-control' id=''>
                                                                        <option value='	Not Updated Yet' disabled>Not Updated Yet</option>
                                                                        <option value='On The Way'>On The Way</option>
                                                                        <option value='Completed'>Completed</option>
