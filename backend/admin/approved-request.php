<title>VBMS || Approved request </title>
<?php
...
$query = "SELECT * FROM tblbook Where status !='Not Updated Yet' LIMIT $start, $limit";
$result = $conn->query($query);
        ...
        <div class="container-fluid">
            <div class="page">
                <nav class="navbar navbar-expand-lg navbar-light bg-light">
                    <a class="navbar-brand" href="#">Approved Booking Request</a>
                </nav>
                <div class="container-fluid">
