...
$query = "SELECT * FROM tblbook Where status='Not Updated Yet' or  status='Rejected'  or accepted_by='$id' LIMIT $start, $limit";
$result = $conn->query($query);
        ...
        <div class="container-fluid">
            <div class="page">
                <nav class="navbar navbar-expand-lg navbar-light bg-light">
                    <a class="navbar-brand" href="#">All Booking Request</a>
                </nav>
                <div class="container-fluid">
