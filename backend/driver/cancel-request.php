<title>VBMS || Cancel request </title>
<?php
...
$query = "SELECT * FROM tblbook Where Status='Rejected' and accepted_by='$id' LIMIT $start, $limit";
$result = $conn->query($query);
...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Cancel Request</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
        ...
        <div class="container-fluid">
            <div class="page">
                <nav class="navbar navbar-expand-lg navbar-light bg-light">
                    <a class="navbar-brand" href="#">Cancel Booking Request</a>
                </nav>
                <div class="container-fluid">
