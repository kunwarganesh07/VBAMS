                        ...
                        <div class="card">
                            <div class="body mt-3">
                                ...
                                if (isset($_POST["submit"])) {
                                    ...
                                    if ($data_driver && isset($data_driver['password'])) { // Check if data exists
                                        if (password_verify($currentpassword, $data_driver['password'])) {
                                            if ($newpassword === $confirmpassword) {
                                                // Passwords match
                                                $changepassword = password_hash($_POST['newpassword'], PASSWORD_BCRYPT);
                                                $query = "UPDATE tbldriver set password='$changepassword' WHERE driverid='$id'";
