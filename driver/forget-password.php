...
if (isset($_POST["submit"])) {
    ...
    $query_admin = "SELECT * FROM tbldriver WHERE email='$email' or phone=$phone";
    ...
    if ($data_admin['email'] == $email && $data_admin['phone'] == $phone) {   // Check if data exists
        if ($newpassword === $confirmpassword) {
            ...
            $query = "UPDATE tbldriver set Password='$changepassword' WHERE email='$email' or phone='$phone'";
        ...
        $error = "<h4 style='color:red;'> Account not found</h4>";
    }
}
